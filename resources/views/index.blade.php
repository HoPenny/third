...
@include('flash::message')
                    <h1 class="mbr-section-title align-left mbr-bold pb-3 mbr-fonts-style display-2">Pets Training School
                    </h1>
                    ...
                    <div class="align-left mbr-section-btn"><a class="btn btn-md btn-primary display-4"
                            href="https://mobirise.co/">VIEW MORE</a> <a class="btn btn-md btn-primary-outline display-4"
                            href="https://mobirise.co/">BOOK NOW</a></div>
                    ...
                    <div class="card-wrapper align-left card1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="269.19780227841716" height="147.43955898849208"
                            ...
                            <rect id="backgroundrect" width="100%" height="100%" x="0" y="0"
                                fill="transparent" stroke="none" class="" style="" fill-opacity="1"></rect>
                        ...
                        <div class="card-box">
                            ...
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a
                                    href="https://mobirise.com/extensions/petsm4/schooldemo.html#" class="text-black">
                                    VIEW MORE</a></h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-wrapper  align-left card2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="269.19780227841716" height="147.43955898849208"
                            ...
                            <g class="currentLayer" style="">
                                ...
                                <path fill="white" fill-opacity="1" stroke="none" stroke-width="2"
                                    stroke-dasharray="none" stroke-linejoin="round" stroke-linecap="butt"
                                    stroke-dashoffset="" fill-rule="nonzero" opacity="1" marker-start=""
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card3 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="269.19780227841716" height="147.43955898849208"
                            style="">
                            <rect id="backgroundrect" width="100%" height="100%" x="0" y="0"
                                fill="transparent" stroke="none" class="" style="" fill-opacity="1">
                            </rect>
                            <g class="currentLayer" style="">
                                <title>Layer 1</title>
                                <path fill="white" fill-opacity="1" stroke="none" stroke-width="2"
                ...
                <div class="col-md-12 content py-4 col-lg-6">
                    ...
                    <ul class="list">
                        ...
                        <li class="item-wrap">
                            ...
                            <h4 class="item1 mbr-regular mbr-fonts-style display-7">Sed cursus ex eu justo consectetur,
                                odio convallis</h4>
                        </li>
                        <li class="item-wrap">
                            <span class="mbr-iconfont mbrib-success"
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-4 btn-col pb-4">
                    <div class="align-left mbr-section-btn"><a class="btn btn-md btn-primary display-4"
                            href="https://mobirise.co/">VIEW ALL<br></a></div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card-wrapper popup-btn">
                        ...
                        <div class="wrapper">
                            <p class="mbr-text align-center mbr-semibold mbr-white mbr-fonts-style display-4">ACTIVITIES
                            </p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 pb-5">
                    <h2 class="align-left mbr-bold mbr-fonts-style display-2"><a
                            href="https://mobirise.com/extensions/petsm4/schooldemo.html#"><strong>Happy to welcome
                                you</strong></a>
                ...
                <div class="card p-3 align-left">
                    <div class="wrap">
                        <div class="pie_progress progress1" role="progressbar" data-goal="50" aria-valuenow="50">
                            <span class="mbr-iconfont mbrib-apple"></span>
                            <div class="undefined"><svg version="1.1" preserveAspectRatio="xMinYMin meet"
                                    viewBox="0 0 150 150">
                                    <ellipse rx="71" ry="71" cx="75" cy="75"
                                        stroke="#f2f2f2" fill="none" stroke-width="8"></ellipse>
                                    <path fill="none" stroke-width="8" stroke="url(#progress-bars2-3f-svg-gradient)"
                                        d="M75,4 A71,71 0 0 1 75.00000000000001,146"
                                        style="stroke-dasharray: 223.084, 223.084; stroke-dashoffset: 0;"></path>
                                </svg></div>
                        </div>
                    </div>
                    <div class="content">
                        <div class="mbr-crt-title">
                            <h4 class="card-title align-center mbr-semibold pb-2 mbr-fonts-style display-7">FOOD SAFETY
                            </h4>
                        </div>
                        ...
                        <div class="pie_progress progress2" role="progressbar" data-goal="60" aria-valuenow="60">
                            ...
                            <div class="undefined"><svg version="1.1" preserveAspectRatio="xMinYMin meet"
                                    ...
                                    <ellipse rx="71" ry="71" cx="75" cy="75"
                                        stroke="#f2f2f2" fill="none" stroke-width="8"></ellipse>
                                    <path fill="none" stroke-width="8" stroke="url(#progress-bars2-3f-svg-gradient)"
                                        d="M75,4 A71,71 0 1 1 33.26724708723444,132.4402066006213"
                                        style="stroke-dasharray: 267.674, 267.674; stroke-dashoffset: 0;"></path>
                                </svg></div>
                        </div>
                    </div>
                    <div class="content">
                        <div class="mbr-crt-title">
                            <h4 class="card-title align-center mbr-semibold pb-2 mbr-fonts-style display-7">ADJUSTED
                                TEMPERATURE</h4>
                        </div>
                        <div class="mbr-crt-text">
                            <p class="mbr-fonts-style align-center mbr-regular card-text display-4">
                        ...
                        <div class="pie_progress progress3" role="progressbar" data-goal="75" aria-valuenow="75">
                            ...
                            <div class="undefined"><svg version="1.1" preserveAspectRatio="xMinYMin meet"
                                    ...
                                    <ellipse rx="71" ry="71" cx="75" cy="75"
                                        stroke="#f2f2f2" fill="none" stroke-width="8"></ellipse>
                                    <path fill="none" stroke-width="8" stroke="url(#progress-bars2-3f-svg-gradient)"
                                        d="M75,4 A71,71 0 1 1 4,75.00000000000001"
                                        style="stroke-dasharray: 334.627, 334.627; stroke-dashoffset: 0;"></path>
                                </svg></div>
                        </div>
                    </div>
                    <div class="content">
                        <div class="mbr-crt-title">
                            <h4 class="card-title align-center mbr-semibold pb-2 mbr-fonts-style display-7">PET MEDICAL
                                HISTORY</h4>
                        </div>
                        <div class="mbr-crt-text">
                            <p class="mbr-fonts-style align-center mbr-regular card-text display-4">
                        ...
                        <div class="pie_progress progress4" role="progressbar" data-goal="100" aria-valuenow="100">
                            ...
                            <div class="undefined"><svg version="1.1" preserveAspectRatio="xMinYMin meet"
                                    ...
                                    <ellipse rx="71" ry="71" cx="75" cy="75"
                                        stroke="#f2f2f2" fill="none" stroke-width="8"></ellipse>
                                    <path fill="none" stroke-width="8" stroke="url(#progress-bars2-3f-svg-gradient)"
                                        d="M75,4 A71,71 0 1 1 74.99955389384317,4.000000001401489"
                                        style="stroke-dasharray: 446.168, 446.168; stroke-dashoffset: 0;"></path>
                                </svg></div>
                        </div>
                    </div>
                    <div class="content">
                                ...
                                <div class="plan-list">
                                    ...
                                    <div class="plan-item d-flex justify-content-center">
                                        <span class="mbr-iconfont mbri-close"
                                            style="color: rgb(56, 56, 56); fill: rgb(56, 56, 56);"></span>
                    ...
                    <div class="wrap">
                        <div class="pie_progress progress1" role="progressbar" data-goal="50" aria-valuenow="50">
                            ...
                            <div class="undefined"><svg version="1.1" preserveAspectRatio="xMinYMin meet"
                                    ...
                                    <ellipse rx="71" ry="71" cx="75" cy="75"
                                        stroke="#f2f2f2" fill="none" stroke-width="8"></ellipse>
                                    <path fill="none" stroke-width="8" stroke="url(#progress-bars1-3z-svg-gradient)"
                                        d="M75,4 A71,71 0 0 1 75.00000000000001,146"
                                        style="stroke-dasharray: 223.084, 223.084; stroke-dashoffset: 0;"></path>
                                </svg></div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 content py-4 col-lg-5 ">
                    <h1 class="mbr-section-title align-left mbr-bold pb-2 mbr-fonts-style display-2"><strong><a
                                href="https://mobirise.com/extensions/petsm4/schooldemo.html#"><b>Robert</b></a>
                        </strong>Sallivan
                    </h1>
    ...
    <section class="carouse1 slide testimonials-slider cid-rGtBR1utsO" data-interval="false"
        ...
        <div class="container text-center">
            ...
            <div class="carousel slide" role="listbox" data-pause="true" data-keyboard="false" data-ride="carousel"
                data-interval="5000" id="testimonials-slider1-3c-carousel">
                ...
                <ol class="carousel-indicators">
                    <li data-app-prevent-settings="" data-target="#testimonials-slider1-3c-carousel" class=""
                        data-slide-to="0"></li>
                    <li data-app-prevent-settings="" data-target="#testimonials-slider1-3c-carousel" data-slide-to="1"
                        class="">
                    </li>
                    <li data-app-prevent-settings="" data-target="#testimonials-slider1-3c-carousel" data-slide-to="2"
                        class="active">
                    </li>
