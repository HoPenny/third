...
<body>
    <section id="top-1" class="engine"><a href="https://mobirise.ws/">Mobirise Website Builder</a> v4.11.2</section>
                ...
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="https://mobirise.com/extensions/petsm4/index.html">
                            <img src="{{ asset('img/logo2.png') }}" alt="Mobirise" title=""
                                style="height: 3rem;">
                        </a>
                    </span>
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-5"
                            href="https://mobirise.com/extensions/petsm4/index.html">PetsM4</a></span>
                </div>
                    ...
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        <li class="nav-item">
                            <a class="nav-link link text-black display-4"
                                href="https://mobirise.com/extensions/petsm4/index.html" aria-expanded="false">
                                Home</a>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link link text-black dropdown-toggle display-4"
                                href="https://mobirise.com/" aria-expanded="false" data-toggle="dropdown-submenu">Live
                                Demo</a>
                            <div class="dropdown-menu"><a class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/boardingdemo.html"
                                    aria-expanded="false">Pets Boarding Services</a><a
                                    class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/shopdemo.html"
                                    aria-expanded="false">Pets Toys and Food Shop</a><a
                                    class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/schooldemo.html"
                        ...
                        <li class="nav-item dropdown"><a class="nav-link link text-black dropdown-toggle display-4"
                                ...
                                Live Demo Blocks</a>
                            <div class="dropdown-menu"><a class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/features.html">Headers / Features /
                                    Content / Countdowns </a><a class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/team.html"
                                    aria-expanded="false">Countres / Accordions / Team / Testimonials </a><a
                                    class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/pricing.html"
                                    aria-expanded="false">Progress / Pricing / Info /
                                    Forms / Clients</a><a class="text-black dropdown-item display-4"
                                    href="https://mobirise.com/extensions/petsm4/shop.html"
                                    aria-expanded="false">Video / Slider / Shop / Maps / Footers </a></div>
                        </li>
                    </ul>

                    <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary-outline display-4"
                            href="http://my.mobirise.com/buy.php?p=81">BUY NOW</a></div>
                </div>
            </div>
        </nav>
    </section>
